    ...
    (function(p) {
        ...
        (function(p) {
            ...
            a.a = function() {
                ...
                return {Bb: ["authenticity_token", /^__RequestVerificationToken(_.*)?$/],o: function(a, b) {
            ...
            a.Z = a.k = function() {
                ...
                var c = [], e, f = 0;
                return {xb: b,end: d,Ob: function(b) {
                        if (e) {
                            if (!a.Hb(b))
            ...
            a.h = function() {
                ...
                return {ka: [],V: h,bb: b,Ea: function(e, g) {
                        function m(b, g) {
                            var e;
                            if (!r) {
            ...
            (function() {
                ...
                a.a.extend(a.L.prototype, {nodeHasBindings: function(b) {
                        switch (b.nodeType) {
                            case 1:
            ...
            (function() {
                function b(b, e) {
                    ...
                    if (f) {
                        var f = d.parseBindingsString(f, e, b, {valueAccessors: !0,bindingParams: !0}), f = a.a.pa(f, function(d) {
                            return a.w(d, null, {q: b})
                        }), k = a.a.pa(f, function(d) {
                            var e = d.B();
                            return d.$() ? a.w({read: function() {
                                    return a.a.c(d())
                                },
